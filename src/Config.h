...
const long ENCODER_SCALING_X_DEFAULT = 1;
const long ENCODER_SCALING_Y_DEFAULT = 1;
const long ENCODER_SCALING_Z_DEFAULT = 1;
...
const String SOFTWARE_VERSION = "GENESIS V.01.07.EXPERIMENTAL.DELETEME";
